...
<main class="main">
  ...
  <section class="singleShopGuide-header page-header">
    <div class="inner">
      <h1 class="page-header__title">
        <span class="page-header__eng">Event・<span>Campaign</span></span>
  ...
  <!-- event-content -->
  <div class="taxEvent-content">
    <div class="taxEvent-content__inner inner">
      ...
      <?php if ($the_query->have_posts()): ?>
        <p class="taxEvent__term-title term-title">
          <span><?php single_term_title(); ?></span>のイベント・キャンペーン情報
        </p>
        <ul class="event-card">
      ...
      <?php else: ?>
        <p class="event-card__not-text not-text">
          ただいま公開中の<br>
