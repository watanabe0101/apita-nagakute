...
<main class="main recruit-tax-main">
  <section class="recruitment-header page-header">
    <div class="inner">
      ...
      <?php breadcrumb_recruit('breadcrumb'); ?>
    </div>
  </section>
    ...
    <div class="recruit-menu__inner inner">
      <ul class="recruit-menu__list">
        <li class="recruit-menu__item">
          <a href="<?php echo esc_url(home_url('/recruit/')); ?>#employment-type" class="recruit-menu__link"><span class="recruit-menu__arrow arrow"></span>雇用形態で探す</a>
        </li>
        <li class="recruit-menu__item">
          <a href="<?php echo esc_url(home_url('/recruit/')); ?>#recruit-category" class="recruit-menu__link"><span class="recruit-menu__arrow arrow"></span>カテゴリで探す</a>
        </li>
        <li class="recruit-menu__item">
